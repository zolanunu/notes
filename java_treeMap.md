---
title: leetcode Array 724 719
date: 2017-12-18
tags: [算法和数据结构, java,treeMap]
categories: [笔记,原创]
---
...
红黑树是一种特殊的二叉查找树，二叉查找树的特征：任意一个节点的键值，大于等于左孩子的键值，小于等于右孩子的键值。
...
红黑树的基本操作是添加、删除和旋转。旋转的目的就是让树保持红黑树的特性。
...
```
package com.algs_4th_xie.C3_Search;
/**
 * Java 语言: 红黑树
 *
 * @author skywang
